...
// 2. Input with search button (CON AUTOCOMPLETADO)
type SearchFriendInputProps = TextInputProps & {
  onSearch?: (value: string) => void;
  clerkUserId?: string; // ← Nuevo prop para autocompletado
};
